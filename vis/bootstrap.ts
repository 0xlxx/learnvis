...
export function bootstrap(selector: string | BaseType, opts: {
  ...
  return { svg: C.svg as unknown as S, W: C.W, H: C.H, M: C.M, stage: { bg: C.bg as unknown as S, nodes: C.nG as unknown as S, edges: C.eG as unknown as S, overlay: C.oG as unknown as S }, root: C.root as unknown as S, palette: p, geom, markerFor };
}
